...
Soluciones de análisis, visualización y gestión de datos para equipos y empresas.
...
- [Resumen](#resumen)
- [Novedades y métricas](#novedades-y-métricas)
...
- APIs y pipelines de datos robustos
- Apps móviles para operaciones y ventas
- Prototipos de IA para insights y automatización
...
- **Móvil:** Flutter, BLoC, Clean Architecture
- **Backend:** NestJS, FastAPI, PostgreSQL, Redis
- **IA & Automatización:** OpenAI, LLM, MCP Protocol
- **Infra & DevOps:** Docker, GitHub Actions, Sentry

---

## Contacto

- Email: tech@rockstardata.ai
- GitHub: https://github.com/rockstardata

---

## Licencia

El contenido de esta organización está disponible bajo la licencia que indique cada repositorio individual.
